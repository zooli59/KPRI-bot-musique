module.exports = {
  Admins: ["844825934384201728", "UserID"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "k!", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/sbySMS7m3v", //Support Server Link
  Token: process.env.Token || "ODc2Mzk2MzQ4MTEzNTY3NzY0.YRjdtA.0_mzPwV40fNh2nBHOnyhEE_ZHRg", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "876396348113567764", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "uNzif3wrJaJGHWrs4k-8j2faVaM8su2T", //Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "7ea4c6b6ea14439cb7ec21083baee0ff", //Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "9f581d38492342799636ed532573aac1", //Spotify Client Secret
  },
};
